...
class TesoreroFilters implements FilterInterface
{
            ...
            if (!$session->get('isLoggedIn') || $session->get('rol') !== 'Tesoreria' && $session->get('rol') !== 'Administrador' && $session->get('rol') !== 'Contador') {
