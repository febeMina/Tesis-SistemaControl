...
<div class="container mt-3">
    ...
    <tr>
        ...
        <td>
            <div class="btn-group">
                <a href="<?= site_url('tipo_permiso/edit/' . $tipo_permiso->idTipoPermiso) ?>" class="btn btn-primary" style="background-color: #007bff;">
                    <i class="mdi mdi-pencil"></i> <!-- Icono de Material Design Icons -->
                </a>
                <!-- Agregar margen entre los botones -->
                <a href="<?= site_url('tipo_permiso/delete/' . $tipo_permiso->idTipoPermiso) ?>" class="btn btn-danger" style="background-color: #dc3545;">
