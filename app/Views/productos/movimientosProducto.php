        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header text-white" style="background-color: #090066; border-radius: 15px;">
                    <h4 class="header-title text-center">Movimientos del producto: <?= $descripcionProducto ?></h4>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table" style="color: #000;">
                            ...
                            <tbody>
                                <?php 
                                    $n = 0;
                                    foreach ($movimientosProducto as $index => $movimiento): 
                                        $n++;
                                ?>
                                <tr>
                                    <td><?= $index + 1 ?></td>
                                    <td><?= $movimiento->codigoLote ?></td>
