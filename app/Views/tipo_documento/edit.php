        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header text-white" style="background-color: #090066;">
                    <h4 class="header-title">Editar Tipo de Documento</h4>
                </div>
                <div class="card-body">
                    <form action="<?= base_url('tipo-documento/update/'.$tipoDocumento['idTipoDocumento']) ?>" method="post">
                        <div class="mb-3">
                            <label for="nombre" class="form-label">Nombre del Tipo de Documento</label>
                            <input type="text" name="nombre" class="form-control" id="nombre" value="<?= esc($tipoDocumento['nombre']) ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="mascara" class="form-label">Máscara</label>
                            <input type="text" name="mascara" class="form-control" id="mascara" value="<?= esc($tipoDocumento['mascara']) ?>" required>
